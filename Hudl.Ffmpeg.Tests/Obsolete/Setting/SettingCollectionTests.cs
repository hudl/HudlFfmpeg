...
namespace Hudl.Ffmpeg.Tests.Obsolete.Setting
{
    public class SettingCollectionTests
    {
        ...
        public void SettingsCollection_Merge()
        {
            ...
            var settingsCollectionO = SettingsCollection.ForOutput(new VCodec(VideoCodecType.Libx264));
            var startAtDefault = new StartAt(2);
            var vcodecDefault = new VCodec(VideoCodecType.Copy);
            ...
            var vcodecSetting = settingsCollectionO.Items[0] as VCodec; 
            ...
            vcodecSetting = settingsCollectionO.Items[0] as VCodec; 
